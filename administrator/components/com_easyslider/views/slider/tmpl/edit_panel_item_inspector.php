						...
						<div class="row">
							<div class="col-xs-12 flex">
								<div class="input-group input-group-xs">
									...
									<input type="text" class="form-control input-50 input-color" data-bind="style.background.color">
<!--									<input type="text" class="form-control" data-bind="style.background.color">-->
								</div>
								<div class="input-group input-group-xs">
								...
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_COLOR');?></label>
									<input type="text" class="form-control input-50 input-color" data-bind="style.border.color">
								</div>
								<div class="input-group input-group-xs">
