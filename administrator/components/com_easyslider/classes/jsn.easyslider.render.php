...
class JSNEasySliderRender
{
    ...
    {
    	$content = '<div id="es-slider-' . $sliderID . '_' . $randID.'" class="es-slider es-slider-' . $sliderID . '">
			<div class="es-slide-progress">
				<div class="es-slide-progress-bar"></div>
			</div>
			<div class="es-viewport">
				<div class="es-background slider-background"></div>
				<div class="es-stage">
					<ul class="es-slides">
						<li class="es-slide">
							<div class="es-swiper"></div>
							<div class="es-background slide-background"></div>
							<ul class="es-items">
								<li class="es-item">
									<div class="item-offset">
										<div class="item-animation">
											<a class="item-container">
												<div class="item-background es-background"></div>
				...
				<nav class="es-nav es-nav-buttons">
    ...
    public function renderScriptTag($sliderID, $randID, $slider)
    {
    	$content = '<script type="text/javascript">
	    	window["es" + (++EasySlider.counter)] = new EasySlider({
	    			el: "#es-slider-' . $sliderID . '_' . $randID . '",
    ...
    protected function _loadAssets()
    {
        ...
        $document->addScript($pathOnly . '/plugins/system/easyslider/assets/lib/underscore/underscore.js');
