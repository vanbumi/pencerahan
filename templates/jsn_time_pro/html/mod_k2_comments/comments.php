...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<p class="lcUsername"><i class="jsn-icon-user"></i> <?php echo JText::_('K2_WRITTEN_BY'); ?>
			...
			<i class="jsn-icon-folder"></i> <span class="lcItemTitle"><a href="<?php echo $comment->itemLink; ?>"><?php echo $comment->title; ?></a></span>
			<?php endif; ?>
