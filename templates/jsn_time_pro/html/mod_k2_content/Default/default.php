...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemAuthor">
	      ...
	      <?php endif; ?>
			<?php if(isset($item->authorLink)): ?>
				<p>by <a rel="author" title="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" href="<?php echo $item->authorLink; ?>"><?php echo $item->author; ?></a></p>
				<?php else: ?>
      ...
      <div class="moduleItemDateCreated"><i class="fa fa-clock-o"></i> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></div>
      <?php endif; ?>

      <?php if($params->get('itemCategory')): ?>
      <div class="moduleItemCategory"><i class="fa fa-bookmark"></i> <a href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></div>
      <?php endif; ?>
