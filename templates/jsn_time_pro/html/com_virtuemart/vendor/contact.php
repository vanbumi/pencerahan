...
<div class="vendor-details-view">
	<h1 class="category-title"><span><?php echo $this->vendor->vendor_store_name;?></span></h1>
	<?php
...
/*	foreach($this->userFields as $userfields){
	...
	<div class="form-field">
		...
		<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">
			...
			<br/>
			<textarea title="<?php echo $ask_comment ?>" class="validate[required,minSize[<?php echo $min ?>],maxSize[<?php echo $max ?>]] field" id="comment" name="comment" style="width: 300px;"></textarea>
			<div class="width50 paddingtop">
