 ...
 * @version $Id: edit_shopper.php 8234 2014-08-25 21:54:44Z Milbo $
 */
...
<div class="buttonBar">
	...
	&nbsp;
	<button class="button reset-btn" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user', FALSE); ?>'" ><?php echo vmText::_('COM_VIRTUEMART_CANCEL'); ?></button>
