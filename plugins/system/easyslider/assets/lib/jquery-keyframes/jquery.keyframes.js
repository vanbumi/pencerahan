(function( $ ) {
    ...
    $.fn.playKeyframe = function(frameOptions, callback) {
        ...
        this.each(function() {
            ...
            if($.keyframe.debug){
                console.group();
                if(vendorPrefix){ log("Vendor Prefix: " + vendorPrefix); }
                log("Style Applied: " + animationcss);
                var testCss = $el.css(animationkey);
                log("Rendered Style: " + (testCss ? testCss : $el[0].style.animation));
                console.groupEnd();
            }
            if (callback) {
